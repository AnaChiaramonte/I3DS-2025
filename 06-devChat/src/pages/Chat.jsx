...
if (message.authorId == "undefined" ){
        == "undeifined" && window.location.reload()
}
    )
    );
    ...
    >
      ...
      >
        {messageList.map((message, index) => (
          <div
            className={`${message.authorId === props.socket.id?"align-self-end ms-5 bg-dark" :"align-self-start me-5 bg-dark-subtle text-dark"} rounded-3 p-2`}
            key={index}
          >
