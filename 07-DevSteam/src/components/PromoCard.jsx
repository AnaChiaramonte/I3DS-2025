    ...
    <div className="promoCard card border-0 overflow-hidden">
      ...
      <div className="card-body d-flex flex-column gap-2">
        ...
        <div className="m-0 row h-100 align-items-center justify-content-center">
          <span className="col-4 h-100 fw-bold h5 m-0 py-3 text-center bg-success">
            -50%
          </span>
          <div className="col h-100 card-text bg-dark">
            ...
            <p className="colorvalor m-0 p-0 fs-4 text-end text-success fw-bolder">
              R$99,99
            </p>
          </div>
        </div>
        <button id="addcarrinho" className="btn btn-success w-100">
